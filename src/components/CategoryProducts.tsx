...
const CategoryProducts = ({ category, title }: { category: string, title: string }) => {
            ...
            >
              ...
              <div className="p-4 grid gap-2">
                ...
                <button
                  ...
                  className="text-sm bg-fuchsia-600 hover:bg-fuchsia-700 text-white px-3 py-2 rounded-full">
                  Add to Cart
                </button>
              </div>
            </Link>
